...
class OrderController extends Controller
{
    ...
    {
        $order = $this->orderService->createOrder($request->validated(), AuthUser::id());
    ...
    {
        $order = $this->orderService->completeOrder($order, AuthUser::id());
    ...
    {
        $payment = $this->orderService->recordPayment($order, $request->validated(), AuthUser::id());
    ...
    {
        $item = $this->orderService->advanceProductionStatus($item, $request->validated('production_status'), AuthUser::id());
